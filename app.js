...
function showAppSection(sectionId) {
  const sections = document.querySelectorAll("#appScreen .page-section");
...
function openMatch(match) {
  ...
  const analysisLeague = $("#analysisLeague");
  const analysisTime = $("#analysisTime");
  const analysisHome = $("#analysisHome");
  const analysisAway = $("#analysisAway");
  const analysisConfidence = $("#analysisConfidence");
  const analysisMarket = $("#analysisMarket");
  const analysisSelection = $("#analysisSelection");
  const analysisOdds = $("#analysisOdds");
  ...
  showAppSection("#matchAnalysis");
}

function closeMatch() {
  selectedMatch = null;

  showAppSection("#matchesSection");
}
